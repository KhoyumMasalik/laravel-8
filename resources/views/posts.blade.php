        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div style="max-height: 400px; overflow:hidden;">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" width="1200" class="img-fluid"
            ...
            @else
                <img src="https://media.istockphoto.com/id/1981727447/id/foto/it-developers-discussing-online-software-development-information-sellable.jpg?s=1024x1024&w=is&k=20&c=Xbn661CTA1Tyd4db7PqnP9Z2eC26GXP4nWKayarEov0="
                    width="1200" height="400" class="card-img-top" alt="{{ $posts[0]->category->name }}">
            @endif
                ...
                <p>
                    <small class="text-muted">
                        By. <a href="/posts?author={{ $posts[0]->author->username }}"
                            class="text-dexoration-none">{{ $posts[0]->author->name }}</a> in <a
                ...
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            @if ($post->image)
                                <img src="{{ asset('storage/' . $post->image) }}" height="250" width="500"
                                ...
                                <p>
                                    <small class="text-muted">
                                        By. <a href="/posts?author={{ $post->author->username }}"
                                            class="text-dexoration-none">{{ $post->author->name }}</a>
